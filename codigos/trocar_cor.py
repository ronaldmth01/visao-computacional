...
def swap_colors(image):
    ...
    # Criando uma máscara para a cor verde
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Uso: python trocar_cor.py caminho_para_sua_imagem.jpg")
        sys.exit()
    ...
    # Salvar a imagem modificada na pasta correta
    output_filename = f"../imagens/modificada_{filename.split('/')[-1]}"
